...
public interface IDao {
	...
	//fact_option
		...
		public ArrayList<RequestDto> managerlistDao(@Param("managernm") String managernm, @Param("factnm") String factnm);
		
		
	//request_mst
		public ArrayList<RequestDto> R_listDao();
		
		public void r_inputDao(String factnm, String requestgr , String requesternm, String requestdate, String requestcomment, String managernm, String reusltstat, String  enddate, String processingtime, String note);
		
		public void deleteDao(String requestno);
		
		public void updateDao(String factnm, String requestgr, String requestdate, String requesternm, String requestcomment, String managernm, String reusltstat,  String enddate,String processingtime, String note, String requestno);
